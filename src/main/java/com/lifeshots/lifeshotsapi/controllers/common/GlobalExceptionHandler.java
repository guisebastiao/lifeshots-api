...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<DefaultDTO> handleMethodArgumentNotValidException(MethodArgumentNotValidException e, HttpServletRequest request) {
        ...
        ErrorDTO errorDTO = new ErrorDTO(HttpStatus.UNPROCESSABLE_ENTITY.value(), HttpStatus.UNPROCESSABLE_ENTITY.name(), request.getRequestURI(), fieldErrorDTO);

        DefaultDTO response = new DefaultDTO("Erro de validação", Boolean.FALSE, null, errorDTO, null);
    ...
    public ResponseEntity<DefaultDTO> handleNicknameAlreadyUsedException(NicknameAlreadyUsedException e, HttpServletRequest request) {
        ...
        ErrorDTO errorDTO = new ErrorDTO(HttpStatus.CONFLICT.value(), HttpStatus.CONFLICT.name(), request.getRequestURI(), List.of(fieldErrorDTO));
    ...
    public ResponseEntity<DefaultDTO> handleIncorrectCredentialsException(IncorrectCredentialsException e, HttpServletRequest request) {
        ...
        ErrorDTO errorDTO = new ErrorDTO(HttpStatus.UNPROCESSABLE_ENTITY.value(), HttpStatus.UNPROCESSABLE_ENTITY.name(), request.getRequestURI(), List.of(emailError,  passwordError));
        DefaultDTO response = new DefaultDTO(e.getMessage(), Boolean.FALSE, null, errorDTO, null);
        return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY).body(response);
    }
    ...
    public ResponseEntity<DefaultDTO> handleDuplicateEntityException(DuplicateEntityException e, HttpServletRequest request) {
        ErrorDTO errorDTO = new ErrorDTO(HttpStatus.CONFLICT.value(), HttpStatus.CONFLICT.name(), request.getRequestURI(), null);
        DefaultDTO response = new DefaultDTO(e.getMessage(), Boolean.FALSE, null, errorDTO, null);
        return ResponseEntity.status(HttpStatus.CONFLICT).body(response);
    }
    ...
    public ResponseEntity<DefaultDTO> handleEntityNotFoundException(EntityNotFoundException e, HttpServletRequest request) {
        ErrorDTO errorDTO = new ErrorDTO(HttpStatus.NOT_FOUND.value(), HttpStatus.NOT_FOUND.name(), request.getRequestURI(), null);
        DefaultDTO response = new DefaultDTO(e.getMessage(), Boolean.FALSE, null, errorDTO, null);
    ...
    public ResponseEntity<DefaultDTO> handlePasswordIncorrectException(PasswordIncorrectException e, HttpServletRequest request) {
        ...
        ErrorDTO errorDTO = new ErrorDTO(HttpStatus.UNPROCESSABLE_ENTITY.value(), HttpStatus.UNPROCESSABLE_ENTITY.name(), request.getRequestURI(), List.of(fieldErrorDTO));
        DefaultDTO response = new DefaultDTO(e.getMessage(), Boolean.FALSE, null, errorDTO, null);
        return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY).body(response);
    }
    ...
    public ResponseEntity<DefaultDTO> handleBadRequestException(BadRequestException e, HttpServletRequest request) {
        ErrorDTO errorDTO = new ErrorDTO(HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.name(), request.getRequestURI(), null);
        DefaultDTO response = new DefaultDTO(e.getMessage(), Boolean.FALSE, null, errorDTO, null);
    ...
    public ResponseEntity<DefaultDTO> handleNotFound(HttpServletRequest request) {
        ErrorDTO errorDTO = new ErrorDTO(HttpStatus.NOT_FOUND.value(), HttpStatus.NOT_FOUND.name(), request.getRequestURI(), null);
        DefaultDTO response = new DefaultDTO("URI não foi encontrada", Boolean.FALSE, null, errorDTO, null);
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(response);
    }
    ...
    public ResponseEntity<DefaultDTO> handleFailedUploadFileException(Exception e, HttpServletRequest request) {
        ErrorDTO errorDTO = new ErrorDTO(HttpStatus.INTERNAL_SERVER_ERROR.value(), HttpStatus.INTERNAL_SERVER_ERROR.name(), request.getRequestURI(), null);
        DefaultDTO response = new DefaultDTO(e.getMessage(), Boolean.FALSE, null, errorDTO, null);
